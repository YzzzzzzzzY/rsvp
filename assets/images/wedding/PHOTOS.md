# Wedding photos — numbered index

Numbers run **grass (01–13) → ground (14–18) → hands (19–21) → dress code (22)**.

| # | File | Category | On page |
|---|------|----------|---------|
| **01** | `01-hero-park-veil-wide.jpg` | Grass | Stagger left (after letter) |
| **02** | `02-outdoor-walking-away.jpg` | Grass | Solo after letter |
| **03** | `03-outdoor-veil-kiss-trees.jpg` | Grass | **Hero (CSS)** |
| **04** | `04-outdoor-park-veil-bench.jpg` | Grass | Stagger right (after letter) |
| **05** | `05-outdoor-veil-spread-bench.jpg` | Grass | Stagger left (with **06**) |
...
| **21** | `21-detail-hands-flowers.jpg` | Hands | Detail trio |
| **22** | `22-dress-code.png` | Dress code | Dress code section |

## Quick swaps

- **Hero:** change number in `assets/css/rsvp.css` → `.rsvp-hero` (currently **03**).
- **Form background:** change **13** in `assets/css/rsvp.css` → `.rsvp-form-section`.
- **In-page photos:** edit paths in `index.html`.
